    ...
    return (
     ...
     data-aos-duration="2000">
                ...
                <div className="flex items-center">
                    ...
                    <p className="text-3xl text-center font-">Hello, I am Tapos Chandro. I have a diploma pass 2023 Computer Science and Technology from Tangail Polytechnic Institute. I want to be a successful Web Developer.</p>
                    </div>
                </div>
            </div>
        </div>
